...
{$scriptName} {$pluginName} import [xmlFileName] [journal_path]
  ...
  'plugins.importexport.native.import.error.duplicatePublicIssueId' => 'O ID público para importar a edição "{$issueTitle}" já está em uso pela edição "{$otherIssueTitle}".',
  ...
  'plugins.importexport.native.import.error.invalidPubId' => 'O arquivo de importação contém um dataset com identificador {$pubIdType} inválido: \'{$pubId}\'.',
  'plugins.importexport.native.import.error.duplicatePubId' => 'O arquivo de importação contém um dataset com identificador {$pubIdType} \'{$pubId}\' já existente para outro objeto na base de dados. Certifique-se de nunca importar objetos com IDs já existentes em sua base.',
  'plugins.importexport.native.import.error.unknownPubId' => 'O arquivo de importação contém um dataset com tipo de ID \'{$pubIdType}\' que nenhum plugin de ID pode tratar. Instale e/ou ative o plugin de ID correspondente antes de tentar importar o dataset.',
  'plugins.importexport.native.import.error.duplicatePublicGalleyId' => 'O ID público "{ $publicId}", fornecido para a composição de importação, está pronto para uso por outra composição do mesmo artigo, "{$articleTitle}".',
  'plugins.importexport.native.import.error.duplicatePublicSuppFileId' => 'O ID público informado para o arquivo suplementar de importação "{$suppFileTitle}" já está sendo usado por outro arquivo suplementar no mesmo artigo, "{$otherSuppFileTitle}".',
  'plugins.importexport.native.import.error.duplicatePublicArticleId' => 'O ID público informado para o artigo de importação "{$articleTitle}" já está em uso por outro artigo, "{$otherArticleTitle}".',
); ?>