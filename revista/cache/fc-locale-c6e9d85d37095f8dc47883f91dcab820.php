<?php return array (
  'default.journalSettings.checklist.notPreviouslyPublished' => 'A contribuição é original e inédita, e não está sendo avaliada para publicação por outra revista; caso contrário, deve-se justificar em "Comentários ao editor".',
  'default.journalSettings.checklist.fileFormat' => 'O arquivo da submissão está em formato Microsoft Word, OpenOffice ou RTF.',
  'default.journalSettings.checklist.submissionAppearance' => 'O texto está em espaço simples; usa uma fonte de 12-pontos; emprega itálico em vez de sublinhado (exceto em endereços URL); as figuras e tabelas estão inseridas no texto, não no final do documento na forma de anexos.',
  'default.journalSettings.checklist.bibliographicRequirements' => 'O texto segue os padrões de estilo e requisitos bibliográficos descritos em <a href="{$indexUrl}/{$journalPath}/about/submissions#authorGuidelines">Diretrizes para Autores</a>, na página Sobre a Revista.',
  'default.journalSettings.checklist.anonymous' => 'Em caso de submissão a uma seção com avaliação pelos pares (ex.: artigos), as instruções disponíveis em <a href="javascript:openHelp(\'{$indexUrl}/{$journalPath}/help/view/editorial/topic/000044\')">Assegurando a avaliação pelos pares cega</a> foram seguidas.',
  'default.journalSettings.privacyStatement' => 'Os nomes e endereços informados nesta revista serão usados exclusivamente para os serviços prestados por esta publicação, não sendo disponibilizados para outras finalidades ou a terceiros.',
  'default.journalSettings.openAccessPolicy' => 'Esta revista oferece acesso livre imediato ao seu conteúdo, seguindo o princípio de que disponibilizar gratuitamente o conhecimento científico ao público proporciona maior democratização mundial do conhecimento.',
  'default.journalSettings.authorSelfArchivePolicy' => 'Autores tem permissão e são encorajados a submeter seus documentos a páginas pessoais ou portais institucionais, antes e após sua publicação neste periódico (sempre oferecendo a referência bibliográfica do item).',
  'default.journalSettings.copyeditInstructions' => 'A edição de texto procura aperfeiçoar a leitura, clareza, gramática, vocabulário e formatação do documento. Representa a última chance para o autor realizar alterações substanciais ao texto, sendo que no próximo passo as correções são restritas a erros de digitação e formatação.
...
{$indexUrl}/{$journalPath}',
  'default.journalSettings.forReaders' => 'Convidamos os leitores a se cadastrarem no serviço de notificação de publicação da revista. Clique em <a href="{$indexUrl}/{$journalPath}/user/register">Cadastro</a> no menu superior da página. O cadastro permitirá ao leitor receber o sumário via e-mail a cada nova edição. A lista procura também reivindicar um nível básico de apoio ou de leitura da revista. Leia a <a href="{$indexUrl}/{$journalPath}/about/submissions#privacyStatement">Política de privacidade</a>, que assegura aos leitores que seus nomes e endereços informados não serão utilizados para outros fins.',
  'default.journalSettings.forAuthors' => 'Deseja enviar contribuições à revista? Convidamos todos a conferir a seção <a href="{$indexUrl}/{$journalPath}/about">Sobre a revista</a> e ler as políticas das seções disponíveis, bem como as <a href="{$indexUrl}/{$journalPath}/about/submissions#authorGuidelines">Diretrizes para autores</a>. É necessário que os autores se <a href="{$indexUrl}/{$journalPath}/user/register">cadastrem</a> no sistema  antes de submeter um artigo; caso já tenha se cadastrado basta <a href="{$indexUrl}/{$journalPath}/login">acessar</a> o sistema e iniciar o processo de 5 passos de submissão.',
  'default.journalSettings.forLibrarians' => 'Convidamos as bibliotecas a listar revistas de Acesso Livre em seus catálogos de revistas eletrônicas. Este sistema de publicação é desenvolvido também para ser hospedado e operado por bibliotecas, em apoio ao trabalho de publicação das revistas do seu corpo acadêmico (saiba mais acessando a página oficial do <a href="http://pkp.sfu.ca/ojs">Open Journal Systems</a>).',
  'default.journalSettings.lockssLicense' => 'Esta revista utiliza o sistema LOCKSS para criar um sistema de arquivo distribuído entre as bibliotecas participantes e permite às mesmas criar arquivos permanentes da revista para a preservação e restauração. <a href="http://lockss.org/">Saiba mais...</a>',
  'default.journalSettings.checklist.addressesLinked' => 'URLs para as referências foram informadas quando possível.',
  'default.journalSettings.refLinkInstructions' => '<h4>Incluindo referências ativas no processo de layout</h4>
...
<p>Copie a palavra com problemas ou o conjunto de palavras e cole no campo de Alterações da prova com as instruções de "ALTERE-PARA" conforme as instruções a seguir.</p>
        ...
        <br />
        <pre>4. FORMATAÇÃO
        O parágrafo iniciado em "Este último elemento..." não está recuado.</pre>',
  'default.journalSettings.submissionFeeDescription' => 'Os autores são obrigados a pagar uma taxa de submissão de artigos no Passo 1 do processo de submissão, como contribuição com os custos de avaliação. Consulte a política de isenção de taxas.',
  'default.journalSettings.fastTrackFeeDescription' => 'O pagamento desta taxa garante que a avaliação, decisão editorial, e notificação do autor ocorram em no máximo 4 semanas.',
  'default.journalSettings.publicationFeeDescription' => 'Caso este documento seja aceito para publicação, será necessário o pagamento de uma taxa de publicação de artigo para auxiliar nos custos de publicação. Consulte a política de isenção de taxas.',
  'default.journalSettings.waiverPolicy' => 'Caso não possa arcar com as taxas descritas, notifique a equipe editorial por meio do campo Comentários, pois não é de interesse da revista que quaisquer taxas impeçam a publicação de trabalhos de alta relevância para o público.',
  'default.journalSettings.membershipFeeDescription' => 'O pagamento desta taxa garante sua inscrição nesta associação durante um ano, com acesso livre a esta revista.',
  'default.journalSettings.donationFeeDescription' => 'Doações de qualquer valor são muito bem-vindas, e oferecem meios aos editores de manter a qualidade da revista no mais alto nível para seus leitores e usuários.',
  'default.journalSettings.purchaseArticleFeeDescription' => 'O pagamento da taxa permitirá visualizar, baixar e imprimir este artigo.',
  'section.default.title' => 'Artigos',
  'section.default.abbrev' => 'ART',
  'default.journalSettings.submissionFee' => 'Submissão de artigo',
  'default.journalSettings.fastTrackFee' => 'Avaliação agilizada',
  'default.journalSettings.publicationFee' => 'Publicação de artigo',
  'default.journalSettings.purchaseArticleFee' => 'Adquirir artigo',
  'default.journalSettings.membershipFee' => 'Registro em entidade de classe',
  'default.journalSettings.donationFee' => 'Doações à revista',
  'section.default.policy' => 'Política padrão de seção',
  'default.journalSettings.purchaseIssueFee' => 'Adquirir edição',
  'default.journalSettings.purchaseIssueFeeDescription' => 'O pagamento desta taxa permite ver, baixar e imprimir esta edição.',
); ?>