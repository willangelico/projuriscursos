<?php return array (
  ...
  'author.submit.submissionSupportingAgencies' => 'Contribuidores e Agências de fomento',
  'author.submit.submissionSupportingAgenciesDescription' => 'Identifique agências (pessoas, organizações, ou serviços) que contribuíram para o conteúdo ou ofereceram apoio financeiro ou logístico para o trabalho apresentado nesta submissão. Separe os agentes por ponto-e-vírgula (ex.: Carlos Silva, Universidade Estadual; Universidade Federal do Estado, Departamento de Ciência da Informação).',
); ?>